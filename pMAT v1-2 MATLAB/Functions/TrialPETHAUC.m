function [FinalData TrialData] = TrialPETHAUC( Fs, Ts, Pre, Post, EventTS,Ch490,Ch405, varargin)
%TrialPETHAUC for use with startoverPC.fig
%   Function called on PETHContinueButton or RunAllButton press if
%   AUCDataCheck, AUCGraphCheck, or ScatterplotCheck is selected.
...
TrialData=DF_ZScore; %Save normalized data for export.
...
CSTrace2=CSTrace2';
FinalData(:,1)=CSTS2';
FinalData(:,2)=CSTrace1;
FinalData(:,3)=CSTrace2;
