function TrialPETHDeltaF( Fs, Ts, Pre, Post, EventTS,Ch490,Ch405, prefix, varargin)
...
% 8-Ch405-Original control channel (405 excitation) data
...
%% %% %% %% %% %% %% 
 ...
 str=varargin(1); % String to name the PETH
...
figure;
h=subplot(2,1,1); 
imagesc(CSTS3,[1:size(DF_F,1)],(DF_F)*100); 
...
subplot(2,1,2),
plot(CSTS3,CSTrace2,'LineWidth',3)
